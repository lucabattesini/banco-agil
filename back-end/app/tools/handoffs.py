...
def route_to_credit(tool_call_id: Annotated[str, InjectedToolCallId]) -> Command:
...
def route_to_score_interview(tool_call_id: Annotated[str, InjectedToolCallId]) -> Command:
...
def route_to_exchange(tool_call_id: Annotated[str, InjectedToolCallId]) -> Command:
